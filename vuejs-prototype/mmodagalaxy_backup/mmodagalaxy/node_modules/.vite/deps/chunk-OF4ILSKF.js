...
// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/multi_marker.js
var MultiMarkerGL = class extends BaseMarkerGL {
  constructor(regl_wrapper, glyph) {
    super(regl_wrapper, glyph);
    __publicField(this, "glyph");
    // data properties, either all or none are set.
    __publicField(this, "_marker_types");
    __publicField(this, "_unique_marker_types");
    this.glyph = glyph;
  }
...
__publicField(MultiMarkerGL, "__name__", "MultiMarkerGL");

export {
  MultiMarkerGL
};
//# sourceMappingURL=chunk-OF4ILSKF.js.map
