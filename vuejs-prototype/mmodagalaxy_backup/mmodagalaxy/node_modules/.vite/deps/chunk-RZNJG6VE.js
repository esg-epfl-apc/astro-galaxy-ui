...
var require_regl = __commonJS({
  "node_modules/regl/dist/regl.js"(exports, module) {
    (function(global, factory) {
      ...
      function checkShaderError(gl, shader9, source, type, command) {
        if (!gl.getShaderParameter(shader9, gl.COMPILE_STATUS)) {
          var errLog = gl.getShaderInfoLog(shader9);
      ...
      function wrapShaderState(gl, stringStore, stats2, config) {
        ...
        function getShader(type, id, command) {
          ...
          var shader9 = cache[id];
          if (!shader9) {
            var source = stringStore.str(id);
            shader9 = gl.createShader(type);
            gl.shaderSource(shader9, source);
            gl.compileShader(shader9);
            check$1.shaderError(gl, shader9, source, type, command);
            cache[id] = shader9;
          }
          return shader9;
        }
      ...
      function reglCore(gl, stringStore, extensions, limits, bufferState, elementState, textureState, framebufferState, uniformState, attributeState, shaderState, drawState, contextState, timer, config) {
        ...
        function parseArguments(options, attributes, uniforms, context, env) {
          ...
          var shader9 = parseProgram(options, env, attribLocations);
          ...
          if (!result.drawVAO && shader9.program && !attribLocations && extensions.angle_instanced_arrays && draw.static.elements) {
            var useVAO = true;
            var staticBindings = shader9.program.attributes.map(function(attr) {
        ...
        function emitScopeProc(env, args) {
          ...
          function saveShader(name) {
            var shader9 = args.shader[name];
            if (shader9) {
              scope.set(shared.shader, "." + name, shader9.append(env, scope));
            }
          }
          saveShader(S_VERT);
          saveShader(S_FRAG);
...
// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/regl_wrap.js
var import_regl = __toESM(require_regl());

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/utils/math.js
function gcd2(a, b) {
  let higher;
  let lower;
  if (a > b) {
...
// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/dash_cache.js
var DashCache = class {
  constructor(regl) {
    __publicField(this, "_regl");
  ...
  _create_texture(pattern) {
    ...
    let len = 0;
    const twice_jumps = [];
    let dist_min = 0, dist_max = 0;
    for (let i = 0; i < n; i++) {
      len += pattern[i];
      twice_jumps.push(pattern[i] + pattern[(i + 1) % n]);
      if (i % 2 == 0) {
        dist_max = Math.max(dist_max, pattern[i]);
      } else {
        dist_min = Math.min(dist_min, -pattern[i]);
      }
    }
    dist_min *= 0.5;
    dist_max *= 0.5;
...
__publicField(DashCache, "__name__", "DashCache");

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/accumulate.vert.js
var shader = `
...
`;
var accumulate_vert_default = shader;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/accumulate.frag.js
var shader2 = `
precision mediump float;
...
`;
var accumulate_frag_default = shader2;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/image.vert.js
var shader3 = `
precision mediump float;
...
`;
var image_vert_default = shader3;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/image.frag.js
var shader4 = `
precision mediump float;
...
`;
var image_frag_default = shader4;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/regl_line.vert.js
var shader5 = `
precision mediump float;
...
`;
var regl_line_vert_default = shader5;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/regl_line.frag.js
var shader6 = `
precision mediump float;
...
`;
var regl_line_frag_default = shader6;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/marker.vert.js
var shader7 = `
precision mediump float;
...
`;
var marker_vert_default = shader7;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/marker.frag.js
var shader8 = `
precision mediump float;
...
`;
var marker_frag_default = shader8;

// node_modules/@bokeh/bokehjs/build/js/lib/models/glyphs/webgl/regl_wrap.js
var regl_wrapper = null;
...
var ReglWrapper = class {
  constructor(gl) {
    __publicField(this, "_regl");
    __publicField(this, "_regl_available");
    __publicField(this, "_dash_cache");
    // Drawing functions.
    __publicField(this, "_accumulate");
    __publicField(this, "_image");
    __publicField(this, "_solid_line");
    __publicField(this, "_dashed_line");
    __publicField(this, "_marker_no_hatch_map", /* @__PURE__ */ new Map());
    __publicField(this, "_marker_hatch_map", /* @__PURE__ */ new Map());
    // Static Buffers/Elements
    __publicField(this, "_line_geometry");
    __publicField(this, "_line_triangles");
    __publicField(this, "_rect_geometry");
    __publicField(this, "_rect_triangles");
    // WebGL state variables.
    __publicField(this, "_scissor");
    __publicField(this, "_viewport");
    // WebGL framebuffer used to accumulate glyph rendering before single blit to Canvas.
    __publicField(this, "_framebuffer");
    __publicField(this, "_framebuffer_texture");
    try {
      this._regl = (0, import_regl.default)({
        gl,
        extensions: [
          "ANGLE_instanced_arrays",
          "EXT_blend_minmax"
...
__publicField(ReglWrapper, "__name__", "ReglWrapper");
function regl_accumulate(regl, geometry, triangles) {
  const config = {
    vert: accumulate_vert_default,
    frag: accumulate_frag_default,
    attributes: {
      a_position: {
        buffer: geometry,
        divisor: 0
...
function regl_image(regl, geometry, triangles) {
  const config = {
    vert: image_vert_default,
    frag: image_frag_default,
    attributes: {
      a_position: {
        buffer: geometry,
        divisor: 0
...
function regl_solid_line(regl, line_geometry, line_triangles) {
  const config = {
    vert: regl_line_vert_default,
    frag: regl_line_frag_default,
    attributes: {
      a_position: {
...
function regl_dashed_line(regl, line_geometry, line_triangles) {
  const config = {
    vert: `#define DASHED
${regl_line_vert_default}
`,
    frag: `#define DASHED
${regl_line_frag_default}
`,
    attributes: {
      a_position: {
        buffer: line_geometry,
...
//# sourceMappingURL=chunk-RZNJG6VE.js.map
